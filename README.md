...
class Game:
    ...
    def max(self):
        ...
        # Return only after checking all possible moves
        return (maxv, px, py)
...
<img width="855" height="850" alt="image" src="https://github.com/user-attachments/assets/89296b5b-d04b-41ef-aca6-9141a2e80ef0" />

<img width="836" height="515" alt="image" src="https://github.com/user-attachments/assets/aa918f1e-790f-4abf-ba01-3b1b86bde951" />
